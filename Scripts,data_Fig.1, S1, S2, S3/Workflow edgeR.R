...
write.csv2(grouping, file="output/edgeR_norm/grouping.csv" )
...
write.csv2(groupingL, file="output/edgeR_norm/groupingL.csv" )
...
write.csv2(groupingC, file="output/edgeR_norm/groupingC.csv" )
...
write.csv2(logCPML, file = "output/edgeR_norm/Stat Tests/logCPML.csv")
lengthL <- myListL$genes$Length * 3
logRPKML <- rpkm(myListL, gene.length = lengthL, log = TRUE)
write.csv2(logRPKML, file = "output/edgeR_norm/Stat Tests/logRPKML.csv")

write.csv2(logCPMC, file = "output/edgeR_norm/Stat Tests/logCPMC.csv")
lengthC <- myListC$genes$Length * 3
logRPKMC <- rpkm(myListC, gene.length = lengthC, log = TRUE)
write.csv2(logRPKMC, file = "output/edgeR_norm/Stat Tests/logRPKMC.csv")
...
for(i in 1:length(names(resultsL))){
  write.csv2(resultsL[[names(resultsL)[i]]], file = paste0("output/edgeR_norm/Stat Tests/", names(resultsL)[i], ".csv"))
}
...
for(i in 1:length(names(resultsC))){
  write.csv2(resultsC[[names(resultsC)[i]]], file = paste0("output/edgeR_norm/Stat Tests/", names(resultsC)[i], ".csv"))
}
...
#liquid
LwspF_liquid <- read.csv2("output/edgeR_norm/Stat Tests/LwspF.csv")
LwspE_liquid <- read.csv2("output/edgeR_norm/Stat Tests/LwspE.csv")
Lrph_liquid <- read.csv2("output/edgeR_norm/Stat Tests/Lrph.csv")
...
write.csv2(Lwrinkly, file = "output/edgeR_norm/Stat Tests/Lwrinkly_liquid.csv")
...
#colony
CwspF_colony <- read.csv2("output/edgeR_norm/Stat Tests/CwspF.csv")
CwspE_colony <- read.csv2("output/edgeR_norm/Stat Tests/CwspE.csv")
Crph_colony <- read.csv2("output/edgeR_norm/Stat Tests/Crph.csv")
...
write.csv2(Cwrinkly, file = "output/edgeR_norm/Stat Tests/Cwrinkly_colony.csv")
...
write.csv2(LwspF_liquid_fdr, file = "output/edgeR_norm/Stat Tests/LwspF_liquid_fdr.csv")
write.csv2(LwspE_liquid_fdr, file = "output/edgeR_norm/Stat Tests/LwspE_liquid_fdr.csv")
write.csv2(Lrph_liquid_fdr, file = "output/edgeR_norm/Stat Tests/Lrph_liquid_fdr.csv")
...
write.csv2(Lwrinkly_sig_fdr, file = "output/edgeR_norm/Stat Tests/Lwrinkly_liquid_sig_fdr.csv")
...
write.csv2(CwspF_colony_fdr, file = "output/edgeR_norm/Stat Tests/CwspF_colony_fdr.csv")
write.csv2(CwspE_colony_fdr, file = "output/edgeR_norm/Stat Tests/CwspE_colony_fdr.csv")
write.csv2(Crph_colony_fdr, file = "output/edgeR_norm/Stat Tests/Crph_colony_fdr.csv")
...
write.csv2(Cwrinkly_colony_sig_fdr, file = "output/edgeR_norm/Stat Tests/Cwrinkly_colony_sig_fdr.csv")